...
const TourSuppliersList = () => {
  ...
  const fetchSuppliers = async () => {
    try {
      ...
      if (data && Array.isArray(data.tour_suppliers || data)) {
        setSuppliers(data.tour_suppliers || data);
  ...
  const handleDelete = async (supplier) => {
    ...
    try {
      ...
      alert('Failed to delete tour supplier. Please try again.');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingSupplier) {
        await tourSuppliersService.update(editingSupplier.id, formData);
      } else {
        await tourSuppliersService.create(formData);
      }
      ...
      alert('Failed to save tour supplier. Please try again.');
    } finally {
      setSubmitting(false);
    }
  };
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Services Offered</th>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => handleFormChange('services_offered', e.target.value)}
                rows={3}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="e.g., City tours, Desert safaris, Historical site visits..."
              />
            </div>
